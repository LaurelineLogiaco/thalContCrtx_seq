...
While code for the first figures of the article is already accessible and should be very understandable, we are still in the process of commenting some of the functions, and the full package is being slowly completed.
